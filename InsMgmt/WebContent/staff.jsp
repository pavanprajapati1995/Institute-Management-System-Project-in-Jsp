...
<script language="javascript" src="validation1.js">
</script>
...
<form   id="form" name="form1" method="post" action="staff1.jsp"  onSubmit="return valid_form(this);">
		<h2 style="color:brown">Employee Registration From</h2>
		<table  align="center">
		<tr>
